...
import type { UploadFile, UploadFiles, UploadRawFile, UploadStatus } from '../types'
import { debugWarn, throwError } from '../utils/error'
import { genFileId, type UploadContentInstance, type UploadContentProps, type UploadProps } from '../utils/upload'
...
export const useUpload = (props: UploadProps, uploadRef: ShallowRef<UploadContentInstance | undefined>) => {
